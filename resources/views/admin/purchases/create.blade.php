        ...
        <form method="POST" action="{{ route('admin.purchases.store') }}" id="purchase-form">
            ...
            <div class="bg-card rounded-2xl border border-theme p-6 shadow-sm hover:shadow-md transition-shadow">
                <div class="flex items-center gap-3 mb-5">
                    ...
                    <span class="ml-auto text-xs text-secondary bg-primary-green-light/20 px-2.5 py-1 rounded-full">Required
                        fields *</span>
                </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <select name="supplier_id" required
                                class="w-full rounded-xl border-theme pl-9 pr-10 py-2.5 bg-primary-green-light/10 text-sm focus:ring-2 focus:ring-primary-green focus:border-transparent transition appearance-none cursor-pointer @error('supplier_id') border-red-500 ring-2 ring-red-500 @enderror">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <select name="warehouse_id" required
                                class="w-full rounded-xl border-theme pl-9 pr-10 py-2.5 bg-primary-green-light/10 text-sm focus:ring-2 focus:ring-primary-green focus:border-transparent transition appearance-none cursor-pointer @error('warehouse_id') border-red-500 ring-2 ring-red-500 @enderror">
                ...
                <div class="mt-4">
                    ...
                    <div class="relative">
                        ...
                        <textarea name="notes" rows="2" placeholder="Add any additional notes about this purchase order..."
                            class="w-full rounded-xl border-theme pl-9 pr-4 py-2.5 bg-primary-green-light/10 text-sm focus:ring-2 focus:ring-primary-green focus:border-transparent transition resize-none">{{ old('notes') }}</textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-card rounded-2xl border border-theme p-6 shadow-sm hover:shadow-md transition-shadow mt-6">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-5">
                    ...
                    <button type="button" id="add-item-btn"
                        class="inline-flex items-center gap-2 rounded-xl border border-theme hover:bg-primary-green-light hover:text-primary-green px-4 py-2 text-sm font-medium text-secondary transition group">
        ...
        <tr class="item-row">
            <td class="py-2 pr-2">
                <div class="relative">
                    <select name="items[__INDEX__][product_id]"
                        class="product-select w-full rounded-xl border-theme pl-3 pr-8 py-2 bg-primary-green-light/10 text-sm focus:ring-2 focus:ring-primary-green focus:border-transparent transition appearance-none cursor-pointer"
                        required>
            ...
            <td class="py-2 px-2">
                <input type="number" name="items[__INDEX__][quantity_ordered]" min="1" value="1"
                    class="qty-input w-full rounded-xl border-theme px-3 py-2 bg-primary-green-light/10 text-sm font-mono-num text-right focus:ring-2 focus:ring-primary-green focus:border-transparent transition"
                    required>
            </td>
            <td class="py-2 px-2">
                <div class="relative">
            ...
            <td class="py-2 text-right">
                <button type="button"
                    class="remove-item-btn p-1.5 rounded-lg text-secondary hover:bg-red-50 hover:text-red-600 transition">
