                ...
                @can('receive', $purchase)
                    @if (in_array($purchase->status->value, ['ordered', 'partially_received']))
                        <button type="button" data-modal-target="receive-items"
                            class="inline-flex items-center gap-2 rounded-xl bg-sage-600 hover:bg-sage-700 dark:bg-sage-500 dark:hover:bg-sage-600 text-sm font-medium px-4 py-2 text-white shadow-sm hover:shadow-md transition">
                        ...
                        @foreach ($purchase->items as $item)
                            ...
                            <tr class="hover:bg-sage-50/50 dark:hover:bg-sage-900/20 transition">
                                ...
                                <td class="px-6 py-4 text-right font-mono-num">
                                    @if ($isFullyReceived)
                                        <span class="text-sage-600 dark:text-sage-400 font-medium flex items-center justify-end gap-1.5">
                                            <x-icon name="check-circle" class="w-3.5 h-3.5" />
                    ...
                    <div
                        ...
                        <div class="flex-shrink-0">
                            <div class="relative w-24">
                                ...
                                <span
                                    class="absolute right-3 top-1/2 -translate-y-1/2 text-xs text-secondary opacity-60"></span>
                            </div>
                        </div>
                    </div>
                @endforeach
