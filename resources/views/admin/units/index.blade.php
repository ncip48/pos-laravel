                    ...
                    <tbody class="divide-y divide-theme">
                        @forelse ($units as $unit)
                            ...
                            <tr class="hover:bg-sage-50/50 dark:hover:bg-sage-900/20 transition group">
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-3">
                                        <div
                                            ...
                                            <x-icon name="scale" class="w-4 h-4 text-sage-600 dark:text-sage-400" />
                                        </div>
                                ...
                                <td class="px-6 py-4">
                                    <span
                                        class="inline-flex items-center gap-1.5 px-3 py-1 rounded-lg bg-sage-100/50 dark:bg-sage-800/30 font-mono-num font-semibold text-sage-700 dark:text-sage-300 text-sm border border-sage-200 dark:border-sage-700">
                                        {{ $unit->symbol }}
                                    </span>
                                </td>
